...
Fock from [huangz1990](https://github.com/huangz1990)/redis-3.0-annotated(https://github.com/huangz1990/redis-3.0-annotated) , 并在阅读学习原有代码的基础上增加了一些自己的改动等；
...
```
make CFLAGS="-O0" PREFIX=/usr/local/redis
```
